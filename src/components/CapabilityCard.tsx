...
export function CapabilityCard({ icon: Icon, title, description, delay = 0 }: Props) {
  return (
    <motion.div
    ...
    >
      ...
      <h3 className="font-display text-base font-semibold text-navy mb-2 relative">{title}</h3>
      <p className="text-sm text-slate leading-relaxed relative">{description}</p>
